...
#ifndef HIPPY_BASE_URL_HOST_H
#define HIPPY_BASE_URL_HOST_H
...
class URLHost {
 public:
  ...
  bool ParseIPv4Host(const std::string& input);
  bool ParseIPv6Host(const std::string& input);
  bool ParseOpaqueHost(const std::string& input);
  bool ParseHost(const std::string& input, bool is_special);
