...
public class MediaPlayerStateWrapper {
  ...
  public void seekTo(int ms) {
    Log.d(tag, "seekTo()");
    if (EnumSet.of(State.PREPARED, State.STARTED, State.PAUSED, State.PLAYBACK_COMPLETE)
  ...
  public void stop() {
    Log.d(tag, "stop()");
    if (EnumSet
      .of(State.PREPARED, State.STARTED, State.STOPPED, State.PAUSED, State.PLAYBACK_COMPLETE)
      .contains(currentState)) {
      mPlayer.stop();
  ...
  public int getDuration() {
    ...
    if (EnumSet
      .of(State.PREPARED, State.STARTED, State.PAUSED, State.STOPPED, State.PLAYBACK_COMPLETE)
      .contains(currentState)) {
