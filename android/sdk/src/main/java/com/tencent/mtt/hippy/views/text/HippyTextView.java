        ...
        try {
            ...
            if (mLayout != null) {
                LogUtils.d("HippyText",
                        "id: " + getId() + " mExtra : " + mLayout.getText() + "layout : w:" + mLayout.getWidth()
                                + " h:" + mLayout.getHeight()
                                + " view : w:" + getWidth() + " h:" + getHeight() + " textColor:" + mLayout.getPaint()
                                .getColor());
                canvas.save();
            ...
            if (context instanceof HippyInstanceContext) {
                ...
                if (hippyEngineContext != null) {
                    HippyExceptionHandlerAdapter defaultExceptionHandler = hippyEngineContext
                            .getGlobalConfigs().getExceptionHandler();
