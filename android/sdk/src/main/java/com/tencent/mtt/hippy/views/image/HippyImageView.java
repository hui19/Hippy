...
public class HippyImageView extends AsyncImageView implements CommonBorder, HippyViewBase,
  ...
  public void setIniProps(HippyMap iniProps) {
    ...
    if (iniProps.containsKey(NodeProps.CUSTOM_PROP_IMAGE_TYPE)) {
      mIniProps.pushString(NodeProps.CUSTOM_PROP_IMAGE_TYPE,
        iniProps.getString(NodeProps.CUSTOM_PROP_IMAGE_TYPE));
    }

    mIniProps
      .pushBoolean(NodeProps.CUSTOM_PROP_ISGIF, iniProps.getBoolean(NodeProps.CUSTOM_PROP_ISGIF));
      ...
      mImageAdapter.fetchImage(url, new HippyImageLoader.Callback() {
        ...
        public void onRequestFail(Throwable throwable, String source) {
          if (TextUtils.equals(mFetchUrl, mUrl)) {
            ...
            if (sourceType == SOURCE_TYPE_SRC && !TextUtils
              .isEmpty(mHippyImageViewDefalutImgeUrl)) {
