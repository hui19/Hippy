...
public class AudioPlayManager {
    ...
    mRunnable = new Runnable() {
      public void run() {
        ...
        if (listener != null && mSysMediaPlayer.isPlaying()) {
          listener.onPlayProgress(mCurrentPlayUrl, mSysMediaPlayer.getCurrentPosition(),
  ...
  private static AudioManager audioManager = (AudioManager) ContextHolder.getAppContext()
  ...
  public static int requestAudioFocus(OnAudioStateChange onAudioStateChange) {
    ...
    try {
      ...
      afChangeListener = new AudioManager.OnAudioFocusChangeListener() {
        public void onAudioFocusChange(int focusChange) {
          if (focusChange == AUDIOFOCUS_LOSS_TRANSIENT) {
            audioManager
              .abandonAudioFocus((AudioManager.OnAudioFocusChangeListener) afChangeListener);
            // 停止播放
      ...
      // 请求播放的音频焦点
      result = audioManager
        .requestAudioFocus((AudioManager.OnAudioFocusChangeListener) afChangeListener,
          // 指定所使用的音频流
