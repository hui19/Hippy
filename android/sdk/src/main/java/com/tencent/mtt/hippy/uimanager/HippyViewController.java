...
public abstract class HippyViewController<T extends View & HippyViewBase> implements
    ...
    public View createView(HippyRootView rootView, int id, HippyEngineContext hippyContext,
    ...
    public void setPid(T view, String pid) {
        if (mEngineContext != null) {
            IHippyDtCollectAdapter collectAdapter = mEngineContext.getGlobalConfigs()
                    .getDtCollectAdapter();
    ...
    public void setAttachedToWindowHandle(T view, boolean flag) {
        if (flag) {
            ...
            view
                    .removeOnAttachStateChangeListener(NativeGestureDispatcher.getOnAttachedToWindowListener());
        }
    }
    ...
    public void setDetachedFromWindowHandle(T view, boolean flag) {
        if (flag) {
            view
                    .addOnAttachStateChangeListener(NativeGestureDispatcher.getOnDetachedFromWindowListener());
        } else {
