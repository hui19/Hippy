...
public class HippyPagerController extends HippyViewController<HippyPager> {
    ...
    protected View createViewImpl(Context context) {
        HippyPager viewPager = new HippyPager(context);
        return viewPager;
    }
    ...
    @Override
    protected void onManageChildComplete(HippyPager viewPager) {
    ...
    @Override
    public void dispatchFunction(HippyPager view, String functionName, HippyArray params, Promise promise) {
        if (view == null) {
            return;
        }
