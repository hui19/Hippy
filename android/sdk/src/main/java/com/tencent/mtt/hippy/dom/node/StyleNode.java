...
public class StyleNode extends DomNode
{
	...
	{
		setStyleMinHeight(FlexConstants.isUndefined(minHeight) ? minHeight : PixelUtil.dp2px(minHeight));
	}
	...
	{
		setStyleMaxHeight(FlexConstants.isUndefined(maxHeight) ? maxHeight : PixelUtil.dp2px(maxHeight));
	}
	...
	{
		setFlexDirection(flexDirection == null ? FlexCSSDirection.COLUMN : FlexCSSDirection.valueOf(flexDirection.toUpperCase(Locale.US).replace("-",
				"_")));
	}
	...
	{
		setAlignSelf(alignSelf == null ? FlexAlign.AUTO : FlexAlign.valueOf(alignSelf.toUpperCase(Locale.US).replace("-", "_")));
	}

	@HippyControllerProps(name = NodeProps.ALIGN_ITEMS)
	public void setAlignItems(String alignItems)
	{
		setAlignItems(alignItems == null ? FlexAlign.STRETCH : FlexAlign.valueOf(alignItems.toUpperCase(Locale.US).replace("-", "_")));
	}

	@HippyControllerProps(name = NodeProps.JUSTIFY_CONTENT)
	public void setJustifyContent(String justifyContent)
	{
		setJustifyContent(justifyContent == null ? FlexJustify.FLEX_START : FlexJustify.valueOf(justifyContent.toUpperCase(Locale.US).replace("-",
				"_")));
	}
	...
	{
		setPadding(FlexSpacing.ALL, FlexConstants.isUndefined(padding) ? padding : PixelUtil.dp2px(padding));
	}
	...
	{
		setPadding(FlexSpacing.VERTICAL, FlexConstants.isUndefined(padding) ? padding : PixelUtil.dp2px(padding));
	}
	...
	{
		setPadding(FlexSpacing.HORIZONTAL, FlexConstants.isUndefined(padding) ? padding : PixelUtil.dp2px(padding));
	}
	...
	{
		setPadding(FlexSpacing.LEFT, FlexConstants.isUndefined(padding) ? padding : PixelUtil.dp2px(padding));
	}
	...
	{
		setPadding(FlexSpacing.RIGHT, FlexConstants.isUndefined(padding) ? padding : PixelUtil.dp2px(padding));
	}
	...
	{
		setPadding(FlexSpacing.TOP, FlexConstants.isUndefined(padding) ? padding : PixelUtil.dp2px(padding));
	}
	...
	{
		setPadding(FlexSpacing.BOTTOM, FlexConstants.isUndefined(padding) ? padding : PixelUtil.dp2px(padding));
	}
	...
	{
		setPosition(FlexSpacing.LEFT, FlexConstants.isUndefined(position) ? position : PixelUtil.dp2px(position));
	}
	...
	{
		setPosition(FlexSpacing.RIGHT, FlexConstants.isUndefined(position) ? position : PixelUtil.dp2px(position));
	}
	...
	{
		setPosition(FlexSpacing.TOP, FlexConstants.isUndefined(position) ? position : PixelUtil.dp2px(position));
	}
	...
	{
		setPosition(FlexSpacing.BOTTOM, FlexConstants.isUndefined(position) ? position : PixelUtil.dp2px(position));
	}

	@HippyControllerProps(name = NodeProps.POSITION)
	public void setPosition(String position)
	{
		FlexPositionType positionType = position == null ? FlexPositionType.RELATIVE : FlexPositionType.valueOf(position.toUpperCase(Locale.US));
