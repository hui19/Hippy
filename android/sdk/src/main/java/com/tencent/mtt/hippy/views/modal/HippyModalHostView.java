...
public class HippyModalHostView extends HippyViewGroup implements
    ...
    mDialog.setOnShowListener(new DialogInterface.OnShowListener() {
      ...
      public void onShow(DialogInterface dialogInterface) {
        ...
        if (mAniType == R.style.Theme_FullScreenDialogAnimatedFade) {
          ObjectAnimator mAlphaAnimation = ObjectAnimator
            .ofFloat(mContentView, "alpha", 0.0f, 1.0f);
  ...
  private void updateProperties() {
    HippyInstanceContext hippyInstanceContext = (HippyInstanceContext) getContext();
    if (hippyInstanceContext != null && (hippyInstanceContext
      .getBaseContext() instanceof Activity)) {
