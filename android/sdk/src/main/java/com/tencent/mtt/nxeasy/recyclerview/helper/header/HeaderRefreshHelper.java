...
/**
 * Created by niuniuyang on 2020/12/17.
 * Description
 * 通过监听recyclerView的onTouch事件，通过下滑的事件，把下滑的位移转换为HeaderView的高度
 * 边下拉，边改变HeaderView的高度，然后调用recyclerView的dispatchLayout，将headerView的高度排版增大，
 * 这样来实现下拉的效果，松手后触发刷新通知
 */
