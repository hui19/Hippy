...
public class FlexNodeStyle {
  ...
  public String toString() {
    ...
    indentation
      .append("flex-direction: " + this.getFlexDirection().toString().toLowerCase() + ", ");
    ...
    if (this.getJustifyContent() != FlexJustify.FLEX_START) {
      indentation
        .append("justifycontent: " + this.getJustifyContent().toString().toLowerCase() + ", ");
    }
  ...
  private native void nativeFlexNodeStyleSetJustifyContent(long nativeFlexNodeStyle,
    int justifyContent);
  ...
  private native void nativeFlexNodeStyleSetPositionType(long nativeFlexNodeStyle,
    int positionType);
  ...
  private native void nativeFlexNodeStyleSetFlexBasisPercent(long nativeFlexNodeStyle,
    float percent);
  ...
  private native void nativeFlexNodeStyleSetMargin(long nativeFlexNodeStyle, int edge,
    float margin);
  ...
  private native void nativeFlexNodeStyleSetMarginPercent(long nativeFlexNodeStyle, int edge,
    float percent);
  ...
  private native void nativeFlexNodeStyleSetPadding(long nativeFlexNodeStyle, int edge,
    float padding);
  ...
  private native void nativeFlexNodeStyleSetPaddingPercent(long nativeFlexNodeStyle, int edge,
    float percent);
  ...
  private native void nativeFlexNodeStyleSetBorder(long nativeFlexNodeStyle, int edge,
    float border);
  ...
  private native void nativeFlexNodeStyleSetPosition(long nativeFlexNodeStyle, int edge,
    float position);
  ...
  private native void nativeFlexNodeStyleSetPositionPercent(long nativeFlexNodeStyle, int edge,
    float percent);
  ...
  public FlexValue getMinWidth() {
    return new FlexValue(mMinWidth,
      FlexValue.Unit.POINT);//(FlexValue) nativeFlexNodeStyleGetMinWidth(mNativePointer);
  }
  ...
  private native void nativeFlexNodeStyleSetMinWidthPercent(long nativeFlexNodeStyle,
    float percent);
  ...
  private native void nativeFlexNodeStyleSetMinHeightPercent(long nativeFlexNodeStyle,
    float percent);
  ...
  private native void nativeFlexNodeStyleSetMaxWidthPercent(long nativeFlexNodeStyle,
    float percent);
  ...
  private native void nativeFlexNodeStyleSetMaxHeightPercent(long nativeFlexNodeStyle,
    float percent);
  ...
  private native void nativeFlexNodeStyleSetAspectRatio(long nativeFlexNodeStyle,
    float aspectRatio);
